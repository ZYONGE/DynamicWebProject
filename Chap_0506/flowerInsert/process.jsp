...
<%@ page import="my.model.Flower, my.dao.FlowerDao, my.util.ConnectionProvider" %>
<%@ page import="com.oreilly.servlet.MultipartRequest, com.oreilly.servlet.multipart.DefaultFileRenamePolicy" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%-- flowerInsert/input.jsp에서 multipart/form-data로 전송된 꽃 정보를 처리.
     이미지 파일은 /Chap_0506/images/ 경로에 저장되고 파일명만 DB에 저장. --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<%
        ...
        // 이미지 저장 경로: 웹 컨텍스트 내 /Chap_0506/images/
